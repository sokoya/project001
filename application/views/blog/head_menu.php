    ...
    <div class="container-fluid">
        <ul class="sub-navigation-menu">
            <li class="submenu-dropdown">
                <a href="javascript:void(0)" data-toggle="dropdown">All Categories &nbsp;<i
...
//                                                                $this->db->cache_off();
            ...
            <li><a href="<?= base_url('blog/tech-news/')?>">Tech News</a></li>
            <li><a href="<?= base_url("blog/how-to/");?>">How To</a></li>
            <li><a href="<?= base_url("explore/");?>">Explore OM</a></li>
