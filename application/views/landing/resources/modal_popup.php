...
<div class="modal fade" id="modal_popup" tabindex="-1" role="dialog"
     aria-hidden="true">
    <div class="modal-dialog modal-sm modal-notify" role="document" style="width:450px;margin: 30px auto;">
        <div class="modal-content text-center">
            <div class="modal-header d-flex justify-content-center bg-warning">
                <p class="heading text-justify"><h3><b>Ask Question</b></h3></p>
            </div>
            <div class="modal-body">
                Please Login
                <form method="post" class="gap-small" autocomplete="off" action="<?= base_url('login/process')?>">
                    <div class="row">
                        <div class="col-md-12">
...
>>>>>>> 07f658039465947f41faa6e3bb5bb056f322542b
</div>