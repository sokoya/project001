            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p class="text-sm foot-link"><a href="<?= base_url('pages'); ?>" style="font-size: 9px;">Terms of Use</a> | <a title="Terms and Agreement"
                                href="<?= base_url('pages/agreement'); ?>" style="font-size: 9px;">Agreement</a> | <a title="Privacy Policy"
                                href="<?= base_url('pages/privacy'); ?>" style="font-size: 9px;">Privacy Policy</a> |
                                <a title="Sitemap" href="https://www.onitshamarket.com/sitemap.xml" style="font-size: 9px;">Privacy Policy</a> |
