            ...
            <div class="brand-slide">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="row" style="margin-left: 10px">
                            <?php
                                $products = $this->product->randomproducts(14, 4);
