                    ...
                    <div class="row" data-gutter="60">
                        <div class="col-md-12" style="margin-bottom: 40px;">
                            ...
                            <h3 class="widget-title text-center text-bold"
                                style="font-weight: bold; font-size: 20px;padding-bottom: 14px;">
                                Reset Password</h3>
                            </p>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="email" name="resetemail"
                                       value="<?php if (isset($_POST['resetemail'])) echo $_POST['resetemail']; ?>"
                                       id="resetemail" placeholder="Please enter your account email"/>
                            </div>
