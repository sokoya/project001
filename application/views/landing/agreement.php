    ...
    <div class="container text-center">
        <div class="row text-justify" style="padding: 20px;background: #fff;">
            ...
            <p>
                ...
                by Internet Onitshamarketing Ltd (“Onitshamarket.com”) as a service to our customers.
            <p/>
            ...
            <p>
                ...
                the terms and conditions related to them and the Security and Privacy policy of Onitshamarket.com.
                Meanwhile, during your purchase and transaction process on the Site, certain Membership Agreement and
                related terms and conditions between you as a Registered User and Onitshamarket.com will bind.
                ...
                relative terms, conditions and the Security and Privacy policy of Onitshamarket.com will apply to your
            ...
            <p>1.2 Terms has not been defined or stipulated in this Agreement shall be interpreted in accordance with
                the definition(s) or provision(s) of the Terms of use of Onitshamarket.com.
            <p/>
            <p> 1.3 Except as explicitly stated otherwise, the registration, services, functions and features on the
                Site is free of charge for our Registered Users, however, Onitshamarket.com reserves the right to charge
                them in the future for whatever reason.
            <p/>
            <p> 1.4 After your registration, you will get a unique Account ID and Password from Onitshamarket.com and
                ...
                this Account ID and Password alone, and, without prior written consent from Onitshamarket.com, you
                should not transfer your Account ID and Password to others for any use. Onitshamarket.com shall never
                take responsibility for any loss or damages related to your incorrect use or transfer of the Account ID
                or Password.
            <p/>
            <p> 1.5 In its sole discretion, Onitshamarket.com may suspend or terminate any account, part of function and
            ...
            <p>
                ...
                any terms and conditions related thereto. Onitshamarket.com may reject a User’s application for
                registration for any reason. Upon registration on the Site, Onitshamarket.com shall assign an account
                (the “Onitshamarket.com Account ID”) and a password (the “Password”) to each Registered User.
            <p/>
            ...
            <p>
                3.1 Each Registered User understands and agrees that Onitshamarket.com is not a traditional seller or
                mart. Throughout the Site, what Onitshamarket.com provides is only an online platform or venue for
                information exchange and transaction between buyers and sellers. Although Onitshamarket.com will monitor
                the regular operation of the Site to fulfill the duty of care, Onitshamarket.com does not review and
            ...
            <p> 3.2 Despite this Agreement, the terms and conditions linked to this Agreement, Security and Privacy
                policy of Onitshamarket.com and other terms and conditions throughout the Site, no agency relationship
                will be created between Onitshamarket.com and the seller or buyer concerning the listing and
                transaction, whether or not such transactions are entered into via the Site.
            <p/>
            <p> 3.3 Registered Users hereby acknowledges that although Onitshamarket.com tries its best to provide the
            ...
            <p/>
            <p> 3.4 In no event shall Onitshamarket.com be responsible for any infringement or transaction dispute,
            ...
            <p/>
            <p> 3.5 The users (including the seller and buyer) agree to release and indemnify Onitshamarket.com and its
            ...
            <p>
                4.1 To the maximum extent permitted by law, this Site is provided by Onitshamarket.com on an “as is”,
            ...
            <p/>
            <p> 4.3 In addition, in no event shall Onitshamarket.com be liable for damages stemming from any one of the
            ...
            <p/>
            <p>4.4 Notwithstanding any of the foregoing provisions, if Onitshamarket.com, our employees, agents,
            ...
            <h4>6. Termination</h4>
            <p>
                The Agreement is effective unless and until terminated by either you or Onitshamarket.com. You may
                ...
                Onitshamarket.com’s right to any Contents, and the provisions of Sections 2, 3, 4, 5, 7, and 8, shall
                survive any termination of this Agreement.
            </p>
            <div style="height:15px;"></div>
            <h4>7. Notice</h4>
            <p>
                7.1 Except as explicitly stated otherwise, all notice or demand to or upon Onitshamarket.com shall be in
                writing and delivered to Onitshamarket.com by mail to the following address: eCommerce Store, Onitsha
                Main Market
                Onitsha, Anambra State, Attn: Legal Department. Notice shall be deemed effective when received by
                Onitshamarket.com in any of the above-mentioned manner.
            <p/>
            <p>7.2 All notices or demands to or upon a User shall be effective if delivered personally, by e-mail to the
                e-mail address provided to Onitshamarket.com during the registration process (as updated from time to
            ...
            <h4>8. General</h4>
            <p>
                8.1 Onitshamarket.com reserves the right to update or modify this Registration Agreement at any time
            ...
            <p/>
            <p> 8.4 The failure of Onitshamarket.com to act with respect to a breach of this Agreement by you or others
