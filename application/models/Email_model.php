...
class Email_model extends CI_Model {
    ...
    function sendSellerOrder( $selleretails ){
        ...
        foreach( $selleretails['products'] as $product) {
            $loop .= '<td><img src="'.PRODUCTS_IMAGE_PATH.$product['image_name'].'" alt="Image"></td>';
