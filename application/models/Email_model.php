...
<table align="center" border=0" cellpadding="0" cellspacing="0" width="600"
    ...
    <tr>
                    ...
                    <td style="padding: 10px 10px 10px 10px;">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%"
                            ...
                            <tr>
                                ...
                                <th style="text-align:center;"><a href="'.base_url('catalog/computing/').'"
                                                                  style="text-decoration:none; color: #333333;"><span
        ...
        return $this->do_email($mail_template, 'Your Order - '. $order_code .' was successful.', $buyer['email'], 'sales@onitshamarket.com');
    }
...
<table align="center" border=0" cellpadding="0" cellspacing="0" width="600"
    ...
    <tr>
        ...
        <td style="padding: 30px 10px 10px 10px; color: #153643; font-family: Arial, sans-serif; font-size: 13px;">
            <p>Dear ' .$buyer["name"]. ',</p>
            <p>Thank you for shopping with us. Unfortunately, your order <b>'. $order_code.'</b> was unsuccessful,
            </p>
