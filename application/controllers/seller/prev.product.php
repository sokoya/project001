    ...
    */
    ...
    public function load_images( $id = ''){
        ...
        foreach( $galleries as $gallery){
            $explode = explode('|', $gallery->image_name);
            $obj['filename'] = $explode[1];
            $obj['fileURL'] = base_url('data/products/' . $id . '/' . $explode[1]);
            $obj['filesize'] = filesize(realpath('./data/products/'. $id.'/'.$explode[1]));
